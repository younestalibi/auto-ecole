    ...
    <div class="layout-wrapper layout-content-navbar layout-without-menu">
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <nav style="min-width:100vw !important" class="navbar-light bg-white layout-navbar m-0 wv-100 container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                    id="layout-navbar">
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item lh-1 me-3">
                                <a class="github-button text-dark" href="#">{{ Auth::user()->name }}</a>
                            </li>
